...
int lab5_main(void) {
    ...
    GPIO_InitTypeDef I2C2_Pin_init = { GPIO_PIN_11, // SETTINGS FOR PB11
                                    GPIO_MODE_AF_OD,
                                    GPIO_AF1_I2C2
    };
    ...
    GPIO_InitTypeDef I2C23_Pin_init = { GPIO_PIN_13, // SETTINGS FOR PB11
        GPIO_MODE_AF_OD,
        GPIO_AF1_I2C2
};

    HAL_GPIO_Init(GPIOB, &I2C23_Pin_init); //initialing the I2C2 pins PB11, and PB13
    ...
    I2C2-> CR2 &= ~((0x7F << 16) | (0x3FF << 0)); //CLEARING
